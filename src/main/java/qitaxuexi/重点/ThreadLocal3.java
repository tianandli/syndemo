...
/**
 * 功能描述：使用synchronized解决，一般都用这种方法
 *
 * @author: lijie
 * @date: 2021/7/5 15:27
 * @version: V1.0
...
public class ThreadLocal3 {
    ...
    public static class ParseDateThread3 implements Runnable{
        int i = 0;
        //构造器
        public ParseDateThread3(int i) {
            this.i = i;
        }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            es.execute(new ParseDateThread3(i));
        }
    }
}